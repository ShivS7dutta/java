...
public class BrokenLink {
	...
	public static void main(String[] args) throws Exception {
		...
		{ 
			...
			System.out.println("check href:" +url);
/*
The loop iterates over each link element.
element.getAttribute("href") retrieves the URL from the href attribute.
HttpURLConnection is used to send a request to the URL and check the response code.	
HttpURLConnection is a class in Java that provides an interface for 
